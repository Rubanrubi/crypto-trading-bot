	...
	async load() {
		...
		try {
			...
			this.factory = new ethers.Contract(
			    '0xb7926c0430afb07aa7defde6da862ae0bde767bc', // pancakeswap testnet factory address
			    [
			...
			this.router = new ethers.Contract(
			    '0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3', // pancakeswap testnet router address
			    [
